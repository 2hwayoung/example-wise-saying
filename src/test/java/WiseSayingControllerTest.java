...
//        app.run();
    ...
    void t5() {
        ...
        assertThat(out)
                .containsSubsequence("== 명언 앱 ==", "명언 앱을 종료합니다.");
    ...
    void t14() {
        ...
        boolean rst = FileUtil.exists(WiseSayingFileRepository.getBuildPath());
